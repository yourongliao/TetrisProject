...
public class View : MonoBehaviour {
    ...
    public void ShowMenu()
    {
        ...
        logoName.DOAnchorPosY(-115f, 0.5f);

        menuUI.gameObject.SetActive(true);
        menuUI.DOAnchorPosY(65.8f, 0.5f);
    }

    public void HideMenu()
    {
        logoName.DOAnchorPosY(104f, 0.5f).OnComplete(delegate { logoName.gameObject.SetActive(false); });

        menuUI.DOAnchorPosY(-69f, 0.5f).OnComplete(delegate { menuUI.gameObject.SetActive(false); });
    }
    ...
    public void ShowGameUI(int score=0,int highScore=0)
    {
        ...
        gameUI.DOAnchorPosY(-110.25f, 0.5f);
    }

    public void HideGameUI()
    {
        gameUI.DOAnchorPosY(112f, 0.5f).OnComplete(delegate { gameUI.gameObject.SetActive(false); });
    }
